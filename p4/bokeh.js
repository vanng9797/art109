...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleArray = [];
		this.lights = [{ellipseWidth:300, ellipseHeight:300, alpha:0, offsetX:0, offsetY:-200, color:"#FFFFFF"}, 
						{ellipseWidth:250, ellipseHeight:250, alpha:0, offsetX:-50, offsetY:-100, color:"#FFFFFF"}, 
