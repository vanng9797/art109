...
function init() {
  ...
  const light = new THREE.HemisphereLight(0xd4d4ff, 0x353561, 1);
  light.position.set(0, 0, 0);
  scene.add(light);

  // Add a directional light to the scene
  const directionalLight = new THREE.DirectionalLight(0xff988f, 1);
